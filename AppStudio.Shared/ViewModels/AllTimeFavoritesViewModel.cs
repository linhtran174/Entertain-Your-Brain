...
{
    public class AllTimeFavoritesViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("AllTimeFavoritesDetail", item);
                        });
                }
        ...
        {
            return new AllTimeFavoritesDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("AllTimeFavoritesList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("AllTimeFavoritesDetail");
        }
    }
}
