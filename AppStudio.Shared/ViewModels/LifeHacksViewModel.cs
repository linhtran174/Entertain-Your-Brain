...
{
    public class LifeHacksViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("LifeHacksDetail", item);
                        });
                }
        ...
        {
            return new LifeHacksDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LifeHacksList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LifeHacksDetail");
        }
