...
{
    public class HotViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("HotDetail", item);
                        });
                }
        ...
        {
            return new HotDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("HotList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("HotDetail");
        }
    }
}
