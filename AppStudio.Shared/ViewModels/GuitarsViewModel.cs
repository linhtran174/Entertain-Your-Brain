...
{
    public class GuitarsViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("GuitarsDetail", item);
                        });
                }
        ...
        {
            return new GuitarsDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("GuitarsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("GuitarsDetail");
        }
