...
{
    public class BrusspupViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("BrusspupDetail", item);
                        });
                }
        ...
        {
            return new BrusspupDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("BrusspupList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("BrusspupDetail");
        }
