...
{
    public class ExpermentsViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ExpermentsDetail", item);
                        });
                }
        ...
        {
            return new ExpermentsDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ExpermentsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ExpermentsDetail");
        }
