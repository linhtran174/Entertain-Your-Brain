...
{
    public class SurvivalTechniquesViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("SurvivalTechniquesDetail", item);
                        });
                }
        ...
        {
            return new SurvivalTechniquesDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("SurvivalTechniquesList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("SurvivalTechniquesDetail");
        }
