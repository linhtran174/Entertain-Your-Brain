...
{
    public class TrendingViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("TrendingDetail", item);
                        });
                }
        ...
        {
            return new TrendingDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("TrendingList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("TrendingDetail");
        }
    }
}
