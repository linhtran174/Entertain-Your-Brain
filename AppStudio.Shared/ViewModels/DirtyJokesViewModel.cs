...
{
    public class DirtyJokesViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("DirtyJokesDetail", item);
                        });
                }
        ...
        {
            return new DirtyJokesDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("DirtyJokesList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("DirtyJokesDetail");
        }
    }
}
