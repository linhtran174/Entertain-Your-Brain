...
{
    public class InsaneOnlinePollsViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("InsaneOnlinePollsDetail", item);
                        });
                }
        ...
        {
            return new InsaneOnlinePollsDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("InsaneOnlinePollsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("InsaneOnlinePollsDetail");
        }
    }
}
