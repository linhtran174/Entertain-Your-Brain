...
{
    public class PianoViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("PianoDetail", item);
                        });
                }
        ...
        {
            return new PianoDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("PianoList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("PianoDetail");
        }
