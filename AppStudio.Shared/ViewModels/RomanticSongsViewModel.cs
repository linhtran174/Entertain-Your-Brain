...
{
    public class RomanticSongsViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("RomanticSongsDetail", item);
                        });
                }
        ...
        {
            return new RomanticSongsDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("RomanticSongsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("RomanticSongsDetail");
        }
