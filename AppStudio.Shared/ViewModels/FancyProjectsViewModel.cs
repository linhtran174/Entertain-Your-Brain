...
{
    public class FancyProjectsViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("FancyProjectsDetail", item);
                        });
                }
        ...
        {
            return new FancyProjectsDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("FancyProjectsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("FancyProjectsDetail");
        }
