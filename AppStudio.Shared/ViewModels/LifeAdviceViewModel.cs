...
{
    public class LifeAdviceViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("LifeAdviceDetail", item);
                        });
                }
        ...
        {
            return new LifeAdviceDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("LifeAdviceList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("LifeAdviceDetail");
        }
    }
}
