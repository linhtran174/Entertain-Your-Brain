...
{
    public class QuantumComputerViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("QuantumComputerDetail", item);
                        });
                }
        ...
        {
            return new QuantumComputerDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("QuantumComputerList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("QuantumComputerDetail");
        }
