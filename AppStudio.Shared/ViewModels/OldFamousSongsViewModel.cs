...
{
    public class OldFamousSongsViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("OldFamousSongsDetail", item);
                        });
                }
        ...
        {
            return new OldFamousSongsDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("OldFamousSongsList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("OldFamousSongsDetail");
        }
