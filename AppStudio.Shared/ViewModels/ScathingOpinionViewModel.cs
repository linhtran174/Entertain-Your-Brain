...
{
    public class ScathingOpinionViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("ScathingOpinionDetail", item);
                        });
                }
        ...
        {
            return new ScathingOpinionDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("ScathingOpinionList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("ScathingOpinionDetail");
        }
    }
}
