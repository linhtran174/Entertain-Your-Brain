...
{
    public class FreshViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("FreshDetail", item);
                        });
                }
        ...
        {
            return new FreshDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("FreshList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("FreshDetail");
        }
    }
}
