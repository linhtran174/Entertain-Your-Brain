...
{
    public class OneLinerJokesViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("OneLinerJokesDetail", item);
                        });
                }
        ...
        {
            return new OneLinerJokesDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("OneLinerJokesList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("OneLinerJokesDetail");
        }
    }
}
