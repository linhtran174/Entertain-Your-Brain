...
function a_gameactorsinit$0(s) {
  ...
  return s.rt.enter(a_rabbitadd(s, a_gameactorsinit$1));
}
cs.registerStep(a_gameactorsinit$0, 'a_gameactorsinit$0');

function a_gameactorsinit$1(s) {
  ...
  var t_resumeCtx_7 = s.rt.getBlockingResumeCtx(a_gameactorsinit$4);
  ...
  return a_gameactorsinit$3;
}
cs.registerStep(a_gameactorsinit$1, 'a_gameactorsinit$1');
...
function a_gameactorsinit$4(s) {
  ...
  var t_resumeCtx_11 = s.rt.getBlockingResumeCtx(a_gameactorsinit$5);
...
function a_gameactorsinit$3(s) {
  (s.pc = "xP9LpEBiAsxQA3vy");
  s.rt.logObjectMutation(/* power up */ s.d.$powerup);
  (ok1(s, /* power up */ s.d.$powerup) && /* power up */ s.d.$powerup.hide(s));
  return s.rt.leave();
}
cs.registerStep(a_gameactorsinit$3, 'a_gameactorsinit$3');

function a_gameactorsinit$5(s) {
  (s.pc = "xyMrpeSghUwpHVYN");
  var t_resumeCtx_12 = s.rt.getBlockingResumeCtx(a_gameactorsinit$6);
...
function a_turtlesadd$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_turtlesadd$1, /* enemy entry */ s.d.$enemyentry));
}
cs.registerStep(a_turtlesadd$0, 'a_turtlesadd$0');

function a_turtlesadd$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  t_actRes_0;
  ...
  (s.pc = "qkJX2XT7oUllMipI");
  null;
  }
  (s.pc = "DxT2RN1TtzQqQk8j");
  s.t_bnd_13 = s.$p;
  (s.$i = 0);
  return a_turtlesadd$4;
}
cs.registerStep(a_turtlesadd$1, 'a_turtlesadd$1');

function a_turtlesadd$4(s) {
  if ((s.$i < s.t_bnd_13)) {
  (s.pc = "xxgiDGyexNIvMiBS");
  return s.rt.enter(a_turtleadd(s, a_turtlesadd$6, s.$x, s.$y));
  }
  return s.rt.leave();
}
cs.registerStep(a_turtlesadd$4, 'a_turtlesadd$4');

function a_turtlesadd$6(s) {
  var t_actRes_14 = s.rt.returnedFrom.result;
  t_actRes_14;
  (s.$i++);
  return a_turtlesadd$4;
}
cs.registerStep(a_turtlesadd$6, 'a_turtlesadd$6');
...
function a_turtlesupdate$0(s) {
  ...
  s.t_idx_1 = 0;
  return a_turtlesupdate$1;
}
cs.registerStep(a_turtlesupdate$0, 'a_turtlesupdate$0');

function a_turtlesupdate$1(s) {
  if ((s.t_idx_1 < (s.t_collArr_0.length))) {
  (s.$e = s.t_collArr_0[(s.t_idx_1)]);
  (s.t_idx_1++);
  (s.pc = "osX2528CM59pNROi");
  return s.rt.enter(a_turtleupdate(s, a_turtlesupdate$3, s.$e));
  }
  return s.rt.leave();
}
cs.registerStep(a_turtlesupdate$1, 'a_turtlesupdate$1');
...
function a_gateadd$0(s) {
  ...
  return s.rt.enter(a_gatebaradd(s, a_gateadd$1));
}
cs.registerStep(a_gateadd$0, 'a_gateadd$0');

function a_gateadd$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  (s.$bar = t_actRes_0);
  ...
  return s.rt.enter(a_gatebombsupdate(s, a_gateadd$6, s.$bar));
}
cs.registerStep(a_gateadd$1, 'a_gateadd$1');

function a_gateadd$6(s) {
  var t_actRes_8 = s.rt.returnedFrom.result;
  t_actRes_8;
  return s.rt.leave();
}
cs.registerStep(a_gateadd$6, 'a_gateadd$6');
...
function a_turtlekill$0(s) {
  ...
  return s.rt.enter(a_spritetopic(s, a_turtlekill$6, s.$turtle));
  } else {
  (s.pc = "ZGE4udLa36CJcKWs");
  null;
  }
  return a_turtlekill$5;
  }
  ...
  return s.rt.enter(a_shelladd(s, a_turtlekill$8, s.$turtle));
  }
  return a_turtlekill$2;
}
...
function a_turtlekill$5(s) {
  return a_turtlekill$3;
}
cs.registerStep(a_turtlekill$5, 'a_turtlekill$5');
...
function a_turtlekill$8(s) {
  var t_actRes_13 = s.rt.returnedFrom.result;
  t_actRes_13;
  (s.pc = "IIzgI8N3J2UajD2K");
  return s.rt.enter(a_shelladd(s, a_turtlekill$9, s.$turtle));
}
cs.registerStep(a_turtlekill$8, 'a_turtlekill$8');

function a_turtlekill$2(s) {
  return s.rt.leave();
}
cs.registerStep(a_turtlekill$2, 'a_turtlekill$2');

function a_turtlekill$9(s) {
  var t_actRes_14 = s.rt.returnedFrom.result;
  t_actRes_14;
  (s.pc = "fK84xTkKOlM5LW1C");
  return s.rt.enter(a_bannerscoreincrease(s, a_turtlekill$10, 5));
}
...
function a_gateexplode$0(s) {
  ...
  return s.rt.enter(a_gatebombsexplode(s, a_gateexplode$3, s.$gate));
  } else {
...
function a_gateexplode$2(s) {
  (s.pc = "iv4YpJkXd4dmJ0eU");
  null;
  return s.rt.leave();
}
cs.registerStep(a_gateexplode$2, 'a_gateexplode$2');
...
function a_rabbitadd$0(s) {
  ...
  var t_resumeCtx_8 = s.rt.getBlockingResumeCtx(a_rabbitadd$3);
  ...
  (s.pc = "aVXuFfjSXDSCNrJz");
  null;
  }
  return a_rabbitadd$2;
}
...
cs.registerStep(a_rabbitadd$2, 'a_rabbitadd$2');
...
function a_gameboardinit$0(s) {
  ...
  return s.rt.enter(a_gameboundaryinit(s, a_gameboardinit$1));
}
cs.registerStep(a_gameboardinit$0, 'a_gameboardinit$0');

function a_gameboardinit$1(s) {
  var t_actRes_2 = s.rt.returnedFrom.result;
  t_actRes_2;
  (s.pc = "xEoNZWyUt6FZX47z");
  return s.rt.enter(a_bannerinit(s, a_gameboardinit$2));
}
cs.registerStep(a_gameboardinit$1, 'a_gameboardinit$1');
...
function a_gatesupdate$0(s) {
  ...
  s.t_idx_1 = 0;
  return a_gatesupdate$1;
}
cs.registerStep(a_gatesupdate$0, 'a_gatesupdate$0');

function a_gatesupdate$1(s) {
  if ((s.t_idx_1 < (s.t_collArr_0.length))) {
  (s.$gate = s.t_collArr_0[(s.t_idx_1)]);
  (s.t_idx_1++);
  (s.pc = "yogtguTsaz9buxMX");
  return s.rt.enter(a_gateupdate(s, a_gatesupdate$3, s.$gate));
  }
  return s.rt.leave();
}
cs.registerStep(a_gatesupdate$1, 'a_gatesupdate$1');
...
function a_gamepostprocess$0(s) {
  ...
  return s.rt.enter(a_spritetopic(s, a_gamepostprocess$3, /* rabbit */ s.d.$rabbit));
  } else {
  (s.pc = "wubZAtlb3UvbbdYL");
  null;
  }
  return a_gamepostprocess$2;
}
...
function a_gamepostprocess$4(s) {
  ...
  return s.rt.enter(a_spritetopic(s, a_gamepostprocess$6, s.$turtle));
  }
  return a_gamepostprocess$2;
}
cs.registerStep(a_gamepostprocess$4, 'a_gamepostprocess$4');

function a_gamepostprocess$7(s) {
  if ((s.t_idx_12 < (s.t_collArr_11.length))) {
  (s.$gate = s.t_collArr_11[(s.t_idx_12)]);
  (s.t_idx_12++);
  (s.pc = "gl45blGrtiH027Ps");
  return s.rt.enter(a_gatebombsupdate(s, a_gamepostprocess$9, s.$gate));
  }
  return s.rt.leave();
}
cs.registerStep(a_gamepostprocess$7, 'a_gamepostprocess$7');
...
function a_gamepostprocess$9(s) {
  var t_actRes_13 = s.rt.returnedFrom.result;
  t_actRes_13;
  return a_gamepostprocess$7;
}
cs.registerStep(a_gamepostprocess$9, 'a_gamepostprocess$9');
...
function a_turtleskill$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_turtleskill$2, /* turtle Squish */ s.d.$turtleSquish));
  } else {
  (s.pc = "D1SJ6W45UCjM4X7Y");
  null;
  }
  return a_turtleskill$1;
}
...
function a_turtleskill$2(s) {
  ...
  s.t_idx_5 = 0;
  return a_turtleskill$3;
}
cs.registerStep(a_turtleskill$2, 'a_turtleskill$2');

function a_turtleskill$1(s) {
  return s.rt.leave();
}
cs.registerStep(a_turtleskill$1, 'a_turtleskill$1');
...
function a_turtleskill$3(s) {
  ...
  return s.rt.enter(a_turtlekill(s, a_turtleskill$5, s.$e));
  }
  return a_turtleskill$1;
}
...
function a_shellsupdate$0(s) {
  ...
  s.t_idx_1 = 0;
  return a_shellsupdate$1;
}
cs.registerStep(a_shellsupdate$0, 'a_shellsupdate$0');

function a_shellsupdate$1(s) {
  if ((s.t_idx_1 < (s.t_collArr_0.length))) {
  (s.$shell = s.t_collArr_0[(s.t_idx_1)]);
  (s.t_idx_1++);
  (s.pc = "NHaNnc1iNWg5q4kf");
  return s.rt.enter(a_shellupdate(s, a_shellsupdate$3, s.$shell));
  }
  return s.rt.leave();
}
cs.registerStep(a_shellsupdate$1, 'a_shellsupdate$1');
...
function a_turtleadd$0(s) {
  ...
  var t_resumeCtx_13 = s.rt.getBlockingResumeCtx(a_turtleadd$4);
  ...
  (s.pc = "cMe5hVGCcWw8w2aQ");
  null;
  }
  return a_turtleadd$3;
}
...
cs.registerStep(a_turtleadd$3, 'a_turtleadd$3');
...
function a_gamespawnactors$0(s) {
  ...
  return s.rt.enter(a_gamespawnnext(s, a_gamespawnactors$6));
  } else {
  (s.pc = "xxem7Bxo0fo8Z6IL");
  null;
  }
  return a_gamespawnactors$3;
}
cs.registerStep(a_gamespawnactors$0, 'a_gamespawnactors$0');

function a_gamespawnactors$6(s) {
  var t_actRes_6 = s.rt.returnedFrom.result;
  ...
  return s.rt.enter(a_turtlesadd(s, a_gamespawnactors$9, s.$num_turtles));
  } else {
  (s.pc = "Sm3W4EBh4cE7X2UY");
  null;
  }
  return a_gamespawnactors$8;
}
cs.registerStep(a_gamespawnactors$6, 'a_gamespawnactors$6');

function a_gamespawnactors$3(s) {
  return s.rt.leave();
}
cs.registerStep(a_gamespawnactors$3, 'a_gamespawnactors$3');
...
function a_gamespawnactors$8(s) {
  var t_elseIf_11 = true;
  ...
  return s.rt.enter(a_gateadd(s, a_gamespawnactors$11));
  } else {
  (s.pc = "IqfqXLWhYy46L5NH");
  null;
  }
  return a_gamespawnactors$10;
}
cs.registerStep(a_gamespawnactors$8, 'a_gamespawnactors$8');
...
function a_gamespawnactors$10(s) {
  ...
  return s.rt.enter(a_carrotadd(s, a_gamespawnactors$15));
  } else {
  (s.pc = "XVecp5pBfuOCzKzv");
  null;
  }
  return a_gamespawnactors$14;
}
...
function a_gamespawnactors$14(s) {
  return a_gamespawnactors$3;
}
cs.registerStep(a_gamespawnactors$14, 'a_gamespawnactors$14');
...
function a_bannerhealthupdate$0(s) {
  ...
  return s.rt.enter(a_gameend(s, a_bannerhealthupdate$4));
  }
  return a_bannerhealthupdate$2;
}
cs.registerStep(a_bannerhealthupdate$0, 'a_bannerhealthupdate$0');

function a_bannerhealthupdate$4(s) {
  var t_actRes_3 = s.rt.returnedFrom.result;
  t_actRes_3;
  return a_bannerhealthupdate$2;
}
cs.registerStep(a_bannerhealthupdate$4, 'a_bannerhealthupdate$4');

function a_bannerhealthupdate$2(s) {
  if (s.t_elseIf_1) {
...
cs.registerStep(a_bannerhealthupdate$2, 'a_bannerhealthupdate$2');
...
function a_rabbithealthdecrease$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_rabbithealthdecrease$1, /* health down */ s.d.$healthdown));
}
cs.registerStep(a_rabbithealthdecrease$0, 'a_rabbithealthdecrease$0');

function a_rabbithealthdecrease$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  t_actRes_0;
  ...
  return s.rt.enter(a_bannerhealthupdate(s, a_rabbithealthdecrease$4));
}
cs.registerStep(a_rabbithealthdecrease$1, 'a_rabbithealthdecrease$1');

function a_rabbithealthdecrease$4(s) {
  var t_actRes_3 = s.rt.returnedFrom.result;
  t_actRes_3;
  return s.rt.leave();
}
cs.registerStep(a_rabbithealthdecrease$4, 'a_rabbithealthdecrease$4');
...
function a_gameend$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_gameend$6, /* gong */ s.d.$gong));
}
cs.registerStep(a_gameend$0, 'a_gameend$0');

function a_gameend$6(s) {
  var t_actRes_17 = s.rt.returnedFrom.result;
  t_actRes_17;
  (s.pc = "dYzyFfALCIzFuuST");
  var t_resumeCtx_18 = s.rt.getAwaitResumeCtx(a_gameend$7);
  lib.Time.sleep(3, t_resumeCtx_18);
  return a_gameend$7;
}
cs.registerStep(a_gameend$6, 'a_gameend$6');
...
function a_carrotadd$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_carrotadd$2, /* carrot enter */ s.d.$carrotenter));
  } else {
  (s.pc = "xZr5rt4uKpR9kcoa");
  null;
  }
  return a_carrotadd$1;
}
...
function a_carrotadd$1(s) {
  return s.rt.leave();
}
cs.registerStep(a_carrotadd$1, 'a_carrotadd$1');
...
function a_carrotupdate$0(s) {
  ...
  return s.rt.enter(a_rabbithealthincrease(s, a_carrotupdate$9));
  }
  return a_carrotupdate$7;
  }
  return a_carrotupdate$10;
  } else {
  (s.pc = "x2i8dAWIK2L81rpf");
  null;
  }
  return a_carrotupdate$1;
}
cs.registerStep(a_carrotupdate$0, 'a_carrotupdate$0');

function a_carrotupdate$9(s) {
  var t_actRes_15 = s.rt.returnedFrom.result;
  t_actRes_15;
  return a_carrotupdate$7;
}
cs.registerStep(a_carrotupdate$9, 'a_carrotupdate$9');

function a_carrotupdate$7(s) {
  return a_carrotupdate$10;
}
cs.registerStep(a_carrotupdate$7, 'a_carrotupdate$7');
...
function a_carrotupdate$1(s) {
  return s.rt.leave();
}
cs.registerStep(a_carrotupdate$1, 'a_carrotupdate$1');
...
function a_rabbithealthincrease$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_rabbithealthincrease$1, /* got carrot */ s.d.$gotcarrot));
}
cs.registerStep(a_rabbithealthincrease$0, 'a_rabbithealthincrease$0');

function a_rabbithealthincrease$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  t_actRes_0;
...
cs.registerStep(a_rabbithealthincrease$1, 'a_rabbithealthincrease$1');
...
function a_splashscreen$1(s) {
  ...
  var t_resumeCtx_9 = s.rt.getBlockingResumeCtx(a_splashscreen$2);
...
cs.registerStep(a_splashscreen$1, 'a_splashscreen$1');
...
function a_splashscreen$2(s) {
  ...
  var t_resumeCtx_17 = s.rt.getBlockingResumeCtx(a_splashscreen$3);
...
function a_splashscreen$3(s) {
  ...
  var t_resumeCtx_24 = s.rt.getBlockingResumeCtx(a_splashscreen$4);
...
function a_splashscreen$4(s) {
  ...
  var t_resumeCtx_31 = s.rt.getBlockingResumeCtx(a_splashscreen$5);
...
function a_splashscreen$5(s) {
  ...
  var t_resumeCtx_38 = s.rt.getBlockingResumeCtx(a_splashscreen$6);
...
function a_splashscreen$6(s) {
  ...
  return s.rt.enter(a_splashoptionsshow(s, a_splashscreen$7));
}
...
function a_splashscreen$7(s) {
  ...
  var t_resumeCtx_61 = s.rt.getBlockingResumeCtx(a_splashscreen$8);
...
function a_gamebegin$0(s) {
  ...
  return s.rt.enter(a_gamemetricsinit(s, a_gamebegin$1));
}
cs.registerStep(a_gamebegin$0, 'a_gamebegin$0');

function a_gamebegin$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  t_actRes_0;
  (s.pc = "HK24Jsl9j7v4lx2d");
  return s.rt.enter(a_gameboardinit(s, a_gamebegin$2));
}
cs.registerStep(a_gamebegin$1, 'a_gamebegin$1');

function a_gamebegin$2(s) {
  var t_actRes_1 = s.rt.returnedFrom.result;
  t_actRes_1;
  (s.pc = "G0S4K0AYnORlXGWW");
  return s.rt.enter(a_gameactorsinit(s, a_gamebegin$3));
}
...
function a_gatebarscollidewithr$0(s) {
  ...
  s.t_idx_2 = 0;
  return a_gatebarscollidewithr$1;
}
cs.registerStep(a_gatebarscollidewithr$0, 'a_gatebarscollidewithr$0');

function a_gatebarscollidewithr$1(s) {
  if ((s.t_idx_2 < (s.t_collArr_1.length))) {
  (s.$gate = s.t_collArr_1[(s.t_idx_2)]);
  (s.t_idx_2++);
  return s.rt.enter(a_gateisactive(s, a_gatebarscollidewithr$4, s.$gate));
  }
  return s.rt.leave();
}
cs.registerStep(a_gatebarscollidewithr$1, 'a_gatebarscollidewithr$1');

function a_gatebarscollidewithr$4(s) {
  var t_actRes_3 = s.rt.returnedFrom.result;
  if (t_actRes_3) {
  (s.pc = "xZ2UdVlX7WKZofph");
  return s.rt.enter(a_soundplay(s, a_gatebarscollidewithr$5, /* through gate */ s.d.$throughgate));
  }
  return a_gatebarscollidewithr$3;
}
cs.registerStep(a_gatebarscollidewithr$4, 'a_gatebarscollidewithr$4');

function a_gatebarscollidewithr$5(s) {
  var t_actRes_4 = s.rt.returnedFrom.result;
  t_actRes_4;
  (s.pc = "u4C4F4OkTUAhuOtn");
  return s.rt.enter(a_gateexplode(s, a_gatebarscollidewithr$6, s.$gate));
}
...
function a_turtlescollidewithra$0(s) {
  ...
  s.t_collArr_1 = (ok1(s, s.$collide) && s.$collide.get_enumerator());
  s.t_idx_2 = 0;
  return a_turtlescollidewithra$1;
}
cs.registerStep(a_turtlescollidewithra$0, 'a_turtlescollidewithra$0');

function a_turtlescollidewithra$1(s) {
  if ((s.t_idx_2 < (s.t_collArr_1.length))) {
  (s.$turtle = s.t_collArr_1[(s.t_idx_2)]);
  (s.t_idx_2++);
  return s.rt.enter(a_turtleisactive(s, a_turtlescollidewithra$4, s.$turtle));
  }
  return s.rt.leave();
}
cs.registerStep(a_turtlescollidewithra$1, 'a_turtlescollidewithra$1');

function a_turtlescollidewithra$4(s) {
  var t_actRes_3 = s.rt.returnedFrom.result;
  if (t_actRes_3) {
  (s.pc = "xlJ4oYVN38wvDRp4");
  return s.rt.enter(a_rabbittakesahitfromt(s, a_turtlescollidewithra$5, s.$turtle));
  }
  return a_turtlescollidewithra$3;
}
cs.registerStep(a_turtlescollidewithra$4, 'a_turtlescollidewithra$4');
...
function a_rabbittakesahitfromt$0(s) {
  ...
  return s.rt.enter(a_spritetopic(s, a_rabbittakesahitfromt$3, s.$turtle));
  } else {
  (s.pc = "mMqHytwl0407NgnH");
  null;
  }
  return a_rabbittakesahitfromt$2;
}
...
function a_rabbittakesahitfromt$2(s) {
  ...
  return s.rt.enter(a_rabbithealthdecrease(s, a_rabbittakesahitfromt$6));
}
cs.registerStep(a_rabbittakesahitfromt$2, 'a_rabbittakesahitfromt$2');
...
function a_rabbittakesahitfromt$6(s) {
  var t_actRes_6 = s.rt.returnedFrom.result;
  t_actRes_6;
  return s.rt.leave();
}
cs.registerStep(a_rabbittakesahitfromt$6, 'a_rabbittakesahitfromt$6');
...
function a_shellscollidewithrab$0(s) {
  ...
  return s.rt.enter(a_soundplay(s, a_shellscollidewithrab$2, /* got shell */ s.d.$gotshell));
  } else {
  (s.pc = "nlnfKFKE1FS4bTcO");
  null;
  }
  return a_shellscollidewithrab$1;
}
...
function a_shellscollidewithrab$2(s) {
  ...
  s.t_idx_8 = 0;
  return a_shellscollidewithrab$3;
}
cs.registerStep(a_shellscollidewithrab$2, 'a_shellscollidewithrab$2');

function a_shellscollidewithrab$1(s) {
  return s.rt.leave();
}
cs.registerStep(a_shellscollidewithrab$1, 'a_shellscollidewithrab$1');
...
function a_gatebombsexplode$0(s) {
  ...
  return s.rt.enter(a_turtleskill(s, a_gatebombsexplode$4, t_call_15));
  } else {
  (s.pc = "rmXrDOcH0A5RaDLp");
  return s.rt.enter(a_gatefree(s, a_gatebombsexplode$6, s.$gate));
  }
  return a_gatebombsexplode$3;
}
...
function a_gatebombsexplode$4(s) {
  ...
  return s.rt.enter(a_turtleskill(s, a_gatebombsexplode$5, t_call_17));
}
...
function a_gatebombsexplode$3(s) {
  return s.rt.leave();
}
cs.registerStep(a_gatebombsexplode$3, 'a_gatebombsexplode$3');
...
function a_gameupdateremainder$0(s) {
  ...
  return s.rt.enter(a_shellsupdate(s, a_gameupdateremainder$5));
  }
  return a_gameupdateremainder$2;
}
cs.registerStep(a_gameupdateremainder$0, 'a_gameupdateremainder$0');

function a_gameupdateremainder$5(s) {
  var t_actRes_4 = s.rt.returnedFrom.result;
  t_actRes_4;
  (s.pc = "KD0vC46mbtGE52l0");
  return s.rt.enter(a_turtlesupdate(s, a_gameupdateremainder$6));
}
cs.registerStep(a_gameupdateremainder$5, 'a_gameupdateremainder$5');

function a_gameupdateremainder$2(s) {
  return s.rt.leave();
}
cs.registerStep(a_gameupdateremainder$2, 'a_gameupdateremainder$2');

function a_gameupdateremainder$6(s) {
  var t_actRes_5 = s.rt.returnedFrom.result;
  t_actRes_5;
  (s.pc = "JDBFYAWBOmahwKeK");
  return s.rt.enter(a_gatesupdate(s, a_gameupdateremainder$7));
}
...
function a_gameupdateremainder$7(s) {
  ...
  return s.rt.enter(a_carrotupdate(s, a_gameupdateremainder$8));
}
...
function a_gameupdateremainder$8(s) {
  ...
  return s.rt.enter(a_bannerhealthupdate(s, a_gameupdateremainder$9));
}
...
function a_gameupdateremainder$9(s) {
  ...
  return s.rt.enter(a_bannerscoreupdate(s, a_gameupdateremainder$10));
}
...
function a_gameupdateremainder$10(s) {
  ...
  return s.rt.enter(a_bannermultiplierupda(s, a_gameupdateremainder$11));
}
...
function a_gamecollisions$0(s) {
  ...
  return s.rt.enter(a_gatebombscollidewith(s, a_gamecollisions$1));
}
cs.registerStep(a_gamecollisions$0, 'a_gamecollisions$0');

function a_gamecollisions$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  t_actRes_0;
  (s.pc = "w1zFAbGJYf0j7X0u");
  return s.rt.enter(a_gatebarscollidewithr(s, a_gamecollisions$2));
}
cs.registerStep(a_gamecollisions$1, 'a_gamecollisions$1');

function a_gamecollisions$2(s) {
  var t_actRes_1 = s.rt.returnedFrom.result;
  t_actRes_1;
  (s.pc = "yWf9w6fHpnwExdYV");
  return s.rt.enter(a_turtlescollidewithra(s, a_gamecollisions$3));
}
...
function a_gamecollisions$3(s) {
  ...
  return s.rt.enter(a_shellscollidewithrab(s, a_gamecollisions$4));
}
...
function a_gatebombscollidewith$0(s) {
  ...
  s.t_collArr_1 = (ok1(s, s.$collide) && s.$collide.get_enumerator());
  s.t_idx_2 = 0;
  return a_gatebombscollidewith$1;
}
cs.registerStep(a_gatebombscollidewith$0, 'a_gatebombscollidewith$0');

function a_gatebombscollidewith$1(s) {
  if ((s.t_idx_2 < (s.t_collArr_1.length))) {
  ...
  return s.rt.enter(a_gateisactive(s, a_gatebombscollidewith$4, s.$gate));
  }
  return s.rt.leave();
}
cs.registerStep(a_gatebombscollidewith$1, 'a_gatebombscollidewith$1');

function a_gatebombscollidewith$4(s) {
  var t_actRes_6 = s.rt.returnedFrom.result;
  ok1(s, t_actRes_6);
  if (t_actRes_6) {
  ...
  return s.rt.enter(a_rabbithealthdecrease(s, a_gatebombscollidewith$8));
  } else {
  (s.pc = "VCWDm04xDNKiAxAw");
  null;
  }
  return a_gatebombscollidewith$5;
}
cs.registerStep(a_gatebombscollidewith$4, 'a_gatebombscollidewith$4');

function a_gatebombscollidewith$8(s) {
  var t_actRes_13 = s.rt.returnedFrom.result;
  t_actRes_13;
  return a_gatebombscollidewith$5;
}
cs.registerStep(a_gatebombscollidewith$8, 'a_gatebombscollidewith$8');

function a_gatebombscollidewith$5(s) {
  return a_gatebombscollidewith$1;
}
cs.registerStep(a_gatebombscollidewith$5, 'a_gatebombscollidewith$5');
...
function a_gameupdateall$0(s) {
  ...
  return s.rt.enter(a_rabbitupdate(s, a_gameupdateall$1));
}
cs.registerStep(a_gameupdateall$0, 'a_gameupdateall$0');

function a_gameupdateall$1(s) {
  var t_actRes_0 = s.rt.returnedFrom.result;
  t_actRes_0;
  (s.pc = "awJc4j7eZXIJs9R9");
  return s.rt.enter(a_gamecollisions(s, a_gameupdateall$2));
}
cs.registerStep(a_gameupdateall$1, 'a_gameupdateall$1');

function a_gameupdateall$2(s) {
  var t_actRes_1 = s.rt.returnedFrom.result;
  t_actRes_1;
  (s.pc = "J0wY0M1DT9FAH8tc");
  return s.rt.enter(a_gameupdateremainder(s, a_gameupdateall$3));
}
...
function a_gameupdateall$3(s) {
  ...
  return s.rt.enter(a_gamespawnactors(s, a_gameupdateall$4));
}
...
function a_turtleupdate$0(s) {
  ...
  return s.rt.enter(a_turtlekill(s, a_turtleupdate$3, s.$e));
  }
  return a_turtleupdate$2;
}
...
function a_turtleupdate$2(s) {
  ...
  return s.rt.enter(a_turtletowardsrabbit(s, a_turtleupdate$5, s.$e));
  }
  return a_turtleupdate$4;
  }
  return a_turtleupdate$6;
}
cs.registerStep(a_turtleupdate$2, 'a_turtleupdate$2');
...
function a_soundplay$0(s) {
  ...
  var t_resumeCtx_2 = s.rt.getBlockingResumeCtx(a_soundplay$3);
  (ok1(s, s.$sound) && s.$sound.play(t_resumeCtx_2));
  return a_soundplay$3;
  } else {
  (s.pc = "xKg2m14UuDDC4VIg");
  null;
  }
  return a_soundplay$2;
}
...
function a_soundplay$2(s) {
  return s.rt.leave();
}
cs.registerStep(a_soundplay$2, 'a_soundplay$2');
...
function a_gateupdate$0(s) {
  ...
  return s.rt.enter(a_gatefree(s, a_gateupdate$5, s.$gate));
  }
  return a_gateupdate$4;
  }
  return a_gateupdate$3;
  }
  return a_gateupdate$6;
}
...
function a_gateupdate$3(s) {
  return a_gateupdate$6;
}
cs.registerStep(a_gateupdate$3, 'a_gateupdate$3');
...
function a_gateupdate$6(s) {
  ...
  return s.rt.enter(a_gateexplode(s, a_gateupdate$9, s.$gate));
  }
  return a_gateupdate$8;
  }
  return a_gateupdate$10;
}
...
function a_gateupdate$8(s) {
  return a_gateupdate$10;
}
cs.registerStep(a_gateupdate$8, 'a_gateupdate$8');
...
function a_gateupdate$10(s) {
  ...
  return s.rt.enter(a_gatebarupdate(s, a_gateupdate$12, s.$gate));
  }
  return a_gateupdate$11;
  }
  return a_gateupdate$13;
}
...
function a_shellupdate$0(s) {
  ...
  return s.rt.enter(a_bannermultiplierincr(s, a_shellupdate$4, 2));
  } else {
  ...
  return a_shellupdate$3;
  }
  return a_shellupdate$1;
}
...
function a_shellupdate$3(s) {
  return a_shellupdate$1;
}
cs.registerStep(a_shellupdate$3, 'a_shellupdate$3');

function a_shellupdate$1(s) {
  if (s.t_elseIf_0) {
...
cs.registerStep(a_shellupdate$1, 'a_shellupdate$1');
...
function a_bannerinit$0(s) {
  ...
  return s.rt.enter(a_bannerscoreinit(s, a_bannerinit$1));
}
cs.registerStep(a_bannerinit$0, 'a_bannerinit$0');

function a_bannerinit$1(s) {
  var t_actRes_1 = s.rt.returnedFrom.result;
  ...
  return s.rt.enter(a_bannermultiplierinit(s, a_bannerinit$4));
}
cs.registerStep(a_bannerinit$1, 'a_bannerinit$1');

function a_bannerinit$4(s) {
  var t_actRes_2 = s.rt.returnedFrom.result;
  if (/* banner */ s.d.$banner) {
  /* banner */ s.d.$banner.perform_set("$multiplier", t_actRes_2, s);
  }
  (s.pc = "fLll24EMmY73gsM0");
  return s.rt.enter(a_bannerhealthinit(s, a_bannerinit$6));
}
cs.registerStep(a_bannerinit$4, 'a_bannerinit$4');

function a_bannerinit$6(s) {
  var t_actRes_3 = s.rt.returnedFrom.result;
  if (/* banner */ s.d.$banner) {
  /* banner */ s.d.$banner.perform_set("$health", t_actRes_3, s);
  }
  (s.pc = "xRWj6EkcvA7CSJZz");
  return s.rt.enter(a_bannerframerateinit(s, a_bannerinit$8));
}
cs.registerStep(a_bannerinit$6, 'a_bannerinit$6');

function a_bannerinit$8(s) {
  var t_actRes_4 = s.rt.returnedFrom.result;
  if (/* banner */ s.d.$banner) {
...
cs.registerStep(a_bannerinit$8, 'a_bannerinit$8');
...
function a_main$0(s) {
  ...
  return s.rt.enter(a_optionsinit(s, a_main$1));
}
...
function a_main$1(s) {
  ...
  return s.rt.enter(a_splashscreen(s, a_main$2));
}
...
function a_main$2(s) {
  ...
  return s.rt.enter(a_gamemetricsinit(s, a_main$3));
}
...
function a_gameloop$0(s) {
  ...
  return s.rt.enter(a_gameupdateall(s, a_gameloop$4));
  } else {
  ...
  var t_resumeCtx_17 = s.rt.getAwaitResumeCtx(a_gameloop$7);
  (ok1(s, s.$sleep_time) && lib.Time.sleep(s.$sleep_time, t_resumeCtx_17));
  return a_gameloop$7;
  } else {
  (s.pc = "dySzq1hlFswp4rep");
  null;
  }
  return a_gameloop$6;
  }
...
function a_gameloop$4(s) {
  ...
  return s.rt.enter(a_gamepostprocess(s, a_gameloop$5));
}
...
function a_gameloop$2(s) {
  return s.rt.leave();
}
cs.registerStep(a_gameloop$2, 'a_gameloop$2');
...
function a_tapsprite3asplashcar$0(s) {
  ...
  return s.rt.enter(a_gamebegin(s, a_tapsprite3asplashcar$3));
  } else {
  (s.pc = "f5Y7FmVoKDEeSmYR");
  null;
  }
  return a_tapsprite3asplashcar$2;
}
...
function a_tapsprite3asplashcar$2(s) {
  return s.rt.leave();
}
cs.registerStep(a_tapsprite3asplashcar$2, 'a_tapsprite3asplashcar$2');
...
function a_tapsprite3asplashart$0(s) {
  ...
  return s.rt.enter(a_splashoptionsshow(s, a_tapsprite3asplashart$5));
}
cs.registerStep(a_tapsprite3asplashart$0, 'a_tapsprite3asplashart$0');

function a_tapsprite3asplashart$5(s) {
  var t_actRes_2 = s.rt.returnedFrom.result;
  t_actRes_2;
...
cs.registerStep(a_tapsprite3asplashart$5, 'a_tapsprite3asplashart$5');
...
function a_tapsprite3asplashsou$0(s) {
  ...
  return s.rt.enter(a_splashoptionsshow(s, a_tapsprite3asplashsou$5));
}
cs.registerStep(a_tapsprite3asplashsou$0, 'a_tapsprite3asplashsou$0');

function a_tapsprite3asplashsou$5(s) {
  var t_actRes_2 = s.rt.returnedFrom.result;
  t_actRes_2;
...
cs.registerStep(a_tapsprite3asplashsou$5, 'a_tapsprite3asplashsou$5');
...
cs.authorId = "unknown";
cs.scriptId = "leasc";
cs.scriptGuid = "8dd46b66-3016-44ab-10df-1045eac1affd";
cs.hasLocalData = 1;
})}
