...
namespace AppStudio
{
    ...
    {
        private Guid APP_ID = new Guid("e4f31614-7d41-4310-9652-47e984cb3520");
        public const string APP_NAME = "Entertain Your Brain";
        ...
        {
            TileServices.CreateFlipTile(@"Let's have some fun!", @"Tricks, games, and more...");
        }
        #endregion
    }
}
