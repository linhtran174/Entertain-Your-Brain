...
{
    public sealed partial class OldFamousSongsDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (OldFamousSongsModel != null)
            {
                await OldFamousSongsModel.LoadItemsAsync();
                OldFamousSongsModel.SelectItem(e.Parameter);

                OldFamousSongsModel.ViewType = ViewTypes.Detail;
            }
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (OldFamousSongsModel != null)
            {
                OldFamousSongsModel.GetShareContent(args.Request);
            }
        }
